...
Rails.application.routes.draw do
  ...
  scope '/admins' do
    ...
    get '/export_users', to: 'admins#export_users', as: :admin_export_users    
  ...
  scope '/:room_uid' do
    ...
    get '/votes', to: 'rooms#votes', as: :room_votes
    get '/signs', to: 'rooms#signs', as: :room_signs
    get '/participants', to:'rooms#participants', as: :room_participants
  end

  get '/:bbb_id/vote_infos', to: 'rooms#vote_infos', as: :room_vote_infos
  get '/:vote_id/admin_infos', to: 'votes#admin_infos', as: :vote_admin_infos
