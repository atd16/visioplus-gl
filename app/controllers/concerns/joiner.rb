...
module Joiner
  ...
  def default_meeting_options
    ...
    if Rails.configuration.tic_allow_except_invite
      invite_except_msg = I18n.t("invite_except_message")
      moderator_message += "<br> <hr /> #{invite_except_msg}<br> #{request.base_url + room_path(@room, :t => @room.tic_except_join_token)}"
    end
    {
