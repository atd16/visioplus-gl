...
>>>>>>> upstream/v2
  ...
  create_table "shared_accesses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "tic_weight"
    t.string "tic_status"
    t.integer "tic_proc_user"
    t.index ["room_id"], name: "index_shared_accesses_on_room_id"
    t.index ["tic_proc_user"], name: "index_shared_accesses_on_tic_proc_user"
    t.index ["tic_status"], name: "index_shared_accesses_on_tic_status"
  ...
  create_table "vote_results", force: :cascade do |t|
    t.bigint "vote_id"
    t.bigint "user_id"
    t.bigint "proxied_by_id"
    t.string "value"
    t.integer "weight"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["proxied_by_id"], name: "index_vote_results_on_proxied_by_id"
    t.index ["user_id"], name: "index_vote_results_on_user_id"
    t.index ["vote_id", "user_id"], name: "index_vote_results_on_vote_id_and_user_id", unique: true
  ...
  create_table "votes", force: :cascade do |t|
    ...
    t.index ["created_by_id"], name: "index_votes_on_created_by_id"
  ...
  add_foreign_key "vote_results", "users", column: "proxied_by_id"
  add_foreign_key "vote_results", "votes"
  add_foreign_key "votes", "rooms"
  add_foreign_key "votes", "users", column: "created_by_id"
end
